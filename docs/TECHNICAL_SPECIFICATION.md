...
**REQ-F-002-S:** Оценка мягких навыков (Soft Skills по ФГОС)
**Приоритет:** Высокий
**Описание:** Система ДОЛЖНА оценивать уровень развития универсальных компетенций (УК) пользователя согласно ФГОС ВО.

**Универсальные компетенции ФГОС для оценки:**

| ID | Компетенция | Описание | Макс. балл |
|----|-------------|----------|------------|
| УК-1 | Системное и критическое мышление | Поиск, критический анализ и синтез информации, применение системного подхода для решения задач | 6 |
| УК-2 | Разработка и реализация проектов | Определение круга задач в рамках цели, выбор оптимальных способов решения с учётом ресурсов и ограничений | 4 |
| УК-3 | Командная работа и лидерство | Социальное взаимодействие, реализация своей роли в команде | 4 |
| УК-4 | Коммуникация | Деловая коммуникация в устной и письменной формах на русском и иностранном языках | 8 |
| УК-5 | Межкультурное взаимодействие | Восприятие межкультурного разнообразия в социально-историческом и этическом контекстах | 4 |
| УК-6 | Самоорганизация и саморазвитие | Управление временем, построение траектории саморазвития на основе принципов образования в течение жизни | 4 |

**Детальные требования:**
- **REQ-F-002-S.1:** Система ДОЛЖНА оценивать каждую из 6 УК компетенций
- **REQ-F-002-S.2:** Оценка производится через самодиагностику И анализ диалога AI
- **REQ-F-002-S.3:** Система ДОЛЖНА выявлять сильные и слабые компетенции
- **REQ-F-002-S.4:** Результат: балл по каждой УК + общий балл (макс. 30)
- **REQ-F-002-S.5:** Система ДОЛЖНА давать рекомендации по развитию слабых компетенций

**Метод оценки:**
1. **Косвенная оценка через AI-диалог** — анализ речи, логики, аргументации
2. **Прямая самооценка** — блок вопросов после диалога (опционально)
3. **Комбинированный балл** — взвешенная сумма обоих методов

**Критерии приёмки:**
- Оценки по УК коррелируют с реальным уровнем пользователя
- Рекомендации по развитию конкретны и actionable
- Результаты интегрированы в карьерную дорожную карту

---

**REQ-F-002-V:** Классификация ценностей по категориям
**Приоритет:** Средний
**Описание:** Система ДОЛЖНА группировать ценности по трём категориям для более глубокого анализа.

**Категории ценностей:**

| Категория | Описание | Ценности |
|-----------|----------|----------|
| **Личные ценности** | Что важно в жизни в целом | Искренность, Баланс, Семья, Здоровье |
| **Профессиональные ценности** | Что важно в работе | Карьера, Доход, Признание, Стабильность |
| **Мотиваторы труда** | Что хочет привносить своим трудом | Творчество, Помощь людям, Инновации, Интуиция |

**Детальные требования:**
- **REQ-F-002-V.1:** Ценности из 12 базовых распределяются по 3 категориям
- **REQ-F-002-V.2:** Для каждой категории выделяется топ-1 доминирующая ценность
- **REQ-F-002-V.3:** Результат отображается в профиле пользователя
...
**REQ-I-005:** Универсальные компетенции ФГОС (УК)
- 6 универсальных компетенций согласно ФГОС ВО 3++
- Индикаторы достижения для каждой УК
- Шкала оценки (баллы)
- Связь УК с профессиями и образовательными программами

| УК | Название | Индикаторы | Макс. балл |
|----|----------|------------|------------|
| УК-1 | Системное мышление | Анализ, синтез, критика | 6 |
| УК-2 | Проектная деятельность | Планирование, ресурсы, результат | 4 |
| УК-3 | Командная работа | Роли, взаимодействие, лидерство | 4 |
| УК-4 | Коммуникация | Устная, письменная, иностранный язык | 8 |
| УК-5 | Межкультурность | Разнообразие, этика, история | 4 |
| УК-6 | Саморазвитие | Тайм-менеджмент, lifelong learning | 4 |

**REQ-I-006:** Рекомендации вузов
- Список вузов по профессиям
- Образовательные программы
- Проходные баллы ЕГЭ
- Ссылки на сайты приёмных комиссий
...
- Методика оценки УК компетенций по ФГОС
- Связь ценностей с профессиями и образованием
...
**Источник:** Федеральные государственные образовательные стандарты высшего образования (ФГОС ВО 3++)

**Применение:**
- Универсальные компетенции (УК-1 — УК-6) как основа оценки soft skills
- Индикаторы достижения компетенций
- Связь компетенций с образовательными программами

**Универсальные компетенции ФГОС:**

| УК | Компетенция | Применение в системе |
|----|-------------|---------------------|
| УК-1 | Системное и критическое мышление | Оценка аналитических способностей |
| УК-2 | Разработка и реализация проектов | Оценка проектного мышления |
| УК-3 | Командная работа и лидерство | Определение роли в команде |
| УК-4 | Коммуникация | Оценка коммуникативных навыков |
| УК-5 | Межкультурное взаимодействие | Оценка социального интеллекта |
| УК-6 | Самоорганизация и саморазвитие | Оценка навыков саморазвития |

**Преимущества использования ФГОС:**
- Единый стандарт оценки для всех вузов РФ
- Понятные критерии для абитуриентов
- Связь с образовательными программами
- Рекомендации вузов на основе УК профиля
